...
if(!empty($_POST))
{
    ...
    $sql = "DELETE FROM tb_pecas where cod_pecas = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($id));
    Banco::desconectar();
